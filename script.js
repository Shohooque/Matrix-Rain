...
class Symbol {
    constructor(x, y, fontSize, canvasHeight){
        this.characters = '〜〜々「ーヾゝヽーゞ。、」「ー・々〜ーヽヾゝゞゞ」」「「ーーー」」ヾヾ・・、ヽ。ー々「ゝー・〜ー・〜「。ゞゝー「」〜々々ヾゝ〜ゞヾ、」、々〜ーヽ「ゝきさたしちひぬふむゐぎずるれへねてほゞんをぼべびぱざきかぁうくすつこゔそとっのにひフムツネリミジボロホカアザユモゾヲッェウキヴオシヰピタdsjsvbfvdbufvhjbvuijcer32783674bnr4g7f34ryo437rb43MOHAMMADSHOHOOQUEMOHAMMADSHOHOOQUE';
        this.x = x;
        this.y = y;
